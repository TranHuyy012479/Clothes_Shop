<%-- 
    ...
    Created on : Oct 13, 2024, 9:16:35 PM
    Author     : tranh
--%>
...
<html lang="en">
    <head>
        ...
        <link href='${pageContext.request.contextPath}/view/assets/font-awesome/css/font-awesome.css' rel='stylesheet' type='text/css'>
        ...
        <!-- Slider -->
        <link href="${pageContext.request.contextPath}/view/assets/css/owl.carousel.css" rel="stylesheet">
        <link href="${pageContext.request.contextPath}/view/assets/css/owl.theme.css" rel="stylesheet">
        <link href="${pageContext.request.contextPath}/view/assets/css/owl.transitions.css" rel="stylesheet">
                        ...
                        <div class="min-marg">
                            <nav class="navbar navbar-default">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand" href="home.jsp"><img src="images/logo.png" alt=""></a>
                                </div>
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="active"><a href="blog-detail.jsp">Blog Post</a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-12 blog-block">
                                        <div class="blog-image">
                                            <img src="view/assets/images/blog-1.jpg" alt="" class="img-responsive">
                                        </div>
                                        ...
                                        <div class="row align-left">
                                            <div class="col-md-4">
                                                <img src="view/assets/images/al-left.jpg" class="img-responsive" alt="">
                                            </div>
                                            <div class="col-md-8">
