<%-- 
    Document   : profile
    Created on : Oct 14, 2024, 8:05:15 PM
    Author     : tranh
--%>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img class="img-account-profile mb-2" id="profile-pic" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="">
                            <label for="input-file" class="btn btn-primary">Upload new image</label>
                        ...
                        <div class="card-body">
                            <form action="profile" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" type="text" placeholder="Enter your username" value="${sessionScope.users.username}" name="username" readonly>
                                </div>
                                <!-- Form Row-->
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputPhone" type="tel" placeholder="Enter your phone number" name="phonenumber">
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputBirthday">Date of birth</label>
                                        <input class="form-control" id="inputBirthday" type="date" placeholder="Enter your birthday" name="dob" />
                                    </div>
                                </div>
                                <!-- Save changes button-->
